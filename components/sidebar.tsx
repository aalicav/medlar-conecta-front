  ...
  const navItems = [
    {
      ...
      roles: ["super_admin", "admin", "director", "commercial", "legal", "operational", "financial", "plan_admin", "clinic_admin", "professional", "clinic", "network_manager"],
    },
    {
      title: "Planos de Saúde",
      href: "/health-plans",
      icon: Building2,
      roles: ["super_admin", "admin", "director", "commercial", "plan_admin", "network_manager"],
    },
    {
      title: "Cadastros",
      href: "/professionals",
      icon: Users,
      roles: ["super_admin", "admin", "director", "commercial", "operational", "clinic_admin", "clinic", "network_manager"],
    },
    {
      title: "Pacientes",
      href: "/patients",
    ...
    },
    {
      ...
      href: "/chatbot",
      icon: MessageSquare,
      roles: ["super_admin", "admin", "director", "commercial", "legal", "operational", "financial", "professional", "clinic", "network_manager"],
    },
    {
      title: "Notificações",
      href: "/notifications",
    ...
    },
    {
      ...
      href: "/reports",
      icon: BarChart3,
      roles: ["super_admin", "admin", "director", "commercial", "financial", "plan_admin", "network_manager"],
    },
    {
      title: "Logs",
      href: "/audit-logs",
